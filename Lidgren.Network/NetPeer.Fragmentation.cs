...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		// on user thread
        /*
         * Description:     Modified the return value for specific fragmented pieces.
         * Autor:           Added by CClien
         * Date:            2012/12/01
         */
        ...
        private int SendFragmentedMessage(NetOutgoingMessage msg, IList<NetConnection> recipients, NetDeliveryMethod method, int sequenceChannel)
		{
