...
namespace Lidgren.Network
{
	...
	{
        /*
         *  Description:    The field for count the fragment of last sent.
         *  Author:         Added by CClien
         *  Date:           2012/12/01
         */  
        public int LastNumOfFragment;
		...
		public NetSendResult SendMessage(NetOutgoingMessage msg, NetConnection recipient, NetDeliveryMethod method, int sequenceChannel)
		{
			...
			else
			{
                ...
                /*
                 *  Description:    Set the value to LastNumOfFragment.
                 *  Author:         Added by CClien
                 *  Date:           2012/12/01
                 */
                //SendFragmentedMessage(msg, new NetConnection[] { recipient }, method, sequenceChannel);
				LastNumOfFragment = SendFragmentedMessage(msg, new NetConnection[] { recipient }, method, sequenceChannel);
